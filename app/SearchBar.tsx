...
export default function SearchBar(){
  ...
  <form onSubmit={handleSearch}>   
      ...
      <div className="relative">
          ...
          <input type="search" id="default-search" className="block w-full p-4 pl-10 text-sm text-slate-300 border border-gray-600 rounded-lg bg-gray-700 focus:ring-blue-500 focus:border-blue-500" placeholder="Search" required/>
